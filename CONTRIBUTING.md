...
help you write a unit test, if needed). See tidyverse team’s guide on
[how to create a great issue](https://code-review.tidyverse.org/issues/)
for more advice. When adding a new function to the package, always add
working examples of the new function in roxygen2 documentation under
`#' @examples`.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("NIEHS/chopin", fork = TRUE)`.
...
of Conduct](https://docs.ropensci.org/chopin/CODE_OF_CONDUCT.md). By
